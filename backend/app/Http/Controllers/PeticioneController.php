...
class PeticioneController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if  ($res) {
        return response()->json(['message' => 'Petición creada satisfactoriamente', 'Peticion' => $peticion]);
    }
        return response()->json(['message' => 'Petición creada insatisfactoriamente'], 500);
}
